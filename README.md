...
3. Cargar un archivo Excel con los datos
4. Asignar las columnas correspondientes
5. Generar los informes
6. (Opcional) Generar PDFs individualizados
...
También puedes comprobar manualmente usando el botón **Actualizar**.
